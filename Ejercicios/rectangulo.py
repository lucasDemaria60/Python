...
# Luego, muestra el área y el perímetro del rectángulo utilizando los métodos de la clase# Enunciado:
# Crea una clase llamada "Rectangulo" que represente un rectángulo y 
# tenga los siguientes atributos:
...
print("Su area es " + str(rectangulo.calculo_area()))
print("Su perimetro es " + str(rectangulo.calculo_perimetro()))